...
const siteUrl = 'https://futurecourier.pe';
...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Future Courier | Courier Internacional EE.UU. a Perú — $8.00 USD/kg',
    template: '%s | Future Courier Logistics'
  },
  ...
  authors: [{ name: 'Future Courier Logistics' }],
  creator: 'Future Courier',
  publisher: 'Future Courier',
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    locale: 'es_PE',
    url: siteUrl,
    siteName: 'Future Courier Logistics',
    title: 'Future Courier | Traemos tus compras de EE.UU. a la puerta de tu casa',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Future Courier — Servicio de Courier EE.UU. a Perú — Tarifa $8.00 USD/kg',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Future Courier | Courier EE.UU. → Perú — $8.00 USD/kg',
